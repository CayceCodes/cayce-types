...
describe('Formatter Tests', () => {
    ...
    describe('JsonFormatter', () => {
        ...
        it('should write JSON to file when filename is provided', () => {
            ...
            expect(fs.writeFileSync).toHaveBeenCalledWith('output.json', expect.any(String), 'utf8');
        });
    ...
    describe('SarifFormatter', () => {
        ...
        it('should write SARIF to file when filename is provided', () => {
            ...
            expect(fs.writeFileSync).toHaveBeenCalledWith('output.sarif', expect.any(String), 'utf8');
        });
    ...
    describe('XmlFormatter', () => {
        ...
        it('should write XML to file when filename is provided', () => {
            ...
            expect(fs.writeFileSync).toHaveBeenCalledWith('output.xml', expect.any(String), 'utf8');
        });
